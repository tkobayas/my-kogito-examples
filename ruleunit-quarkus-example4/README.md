...
```
```
curl -X POST -H 'Accept: application/json' -H 'Content-Type: application/json' -d '{"maxAmount":5000,"loanApplications":[{"id":"ABC10001","amount":2000,"deposit":10000,"applicant":{"age":45,"name":"John"}}, {"id":"ABC10002","amount":4000,"deposit":100,"applicant":{"age":25,"name":"Paul"}}, {"id":"ABC10003","amount":2000,"deposit":10000,"applicant":{"age":12,"name":"George"}}]}' http://localhost:8080/find-approved
```
