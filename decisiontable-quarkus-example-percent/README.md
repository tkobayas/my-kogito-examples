...
If you add a property `-Ddrools.dump.dir=/path/to/dir` to the maven command, you can confirm a generated DRL from the spreadsheet in the specified directory.
